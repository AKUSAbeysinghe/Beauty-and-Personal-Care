...
// Hardcoded High-Quality Images (Unsplash)
const hardcodedImages = {
  hero: GroomingBaber,
  barbershop: 'https://images.unsplash.com/photo-1585747860715-2ba37e788b70?q=80&w=2070',
  grooming: 'https://images.unsplash.com/photo-1621600411688-3e3c3f0e8c3e?q=80&w=2070',
  haircut: 'https://images.unsplash.com/photo-1556228720-195a672ee8b6?q=80&w=2070',
  beard: 'https://images.unsplash.com/photo-1503951914875-8f6e8b4c0b1f?q=80&w=2070',
  default: 'https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?q=80&w=2070'
};

// Fallback Services with hardcoded images
const fallbackServices = [
  { id: 1, category_id: 3, sub_category_id: 9, name: 'Classic Haircut', price: 1000, image_url: hardcodedImages.barbershop },
  { id: 2, category_id: 3, sub_category_id: 10, name: 'Hot Towel Shave', price: 800, image_url: hardcodedImages.grooming },
  { id: 3, category_id: 3, sub_category_id: 11, name: 'Fade Haircut', price: 1200, image_url: hardcodedImages.haircut },
  { id: 4, category_id: 3, sub_category_id: 12, name: 'Beard Trim', price: 600, image_url: hardcodedImages.beard },
];
...
const GroomingPage = () => {
  ...
  const fetchServices = async () => {
    ...
    try {
      ...
      if (data.success && Array.isArray(data.data)) {
        ...
        setServices(groomingServices.length > 0 ? groomingServices : fallbackServices);
      } else {
        setServices(fallbackServices);
      }
    } catch (err) {
  ...
  const getMinPrice = (arr) => {
    if (!arr || arr.length === 0) return 600;
    const prices = arr.map(s => Number(s.price) || 0).filter(p => p > 0);
    return prices.length > 0 ? Math.min(...prices) : 600;
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-50" />
        <div className="relative z-10 flex flex-col items-center text-center text-white p-6 max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-black uppercase tracking-tighter">Barbershops & Grooming</h1>
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black uppercase text-gray-900">Barbershops</h2>
            <p className="mt-4 text-lg text-gray-600">Professional barbering services focusing on precision cuts and classic styles.</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <img
                src={getSubCategoryImage(barbershopServices, 'barbershop')}
                alt="Barbershop"
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-2xl font-bold">Barbershops</h3>
              </div>
              {loading ? <p>Loading services...</p> : (
                <ul className="space-y-3 mb-8">
                  {barbershopServices.length > 0 ? barbershopServices.map(s => (
              ...
              <div className="mt-auto flex items-center justify-between">
                <p className="text-xl font-semibold">From <span className="font-bold">Rs.{getMinPrice(barbershopServices)}</span></p>
      ...
      <section className="bg-gray-50 py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black uppercase text-gray-900">Grooming Services</h2>
            <p className="mt-4 text-lg text-gray-600">Luxurious grooming services for a refined appearance.</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col">
              <div className="flex items-center gap-4 mb-4">
                <span className="bg-black text-white p-3 rounded-full"><ScissorsIcon className="h-6 w-6" /></span>
                <h3 className="text-2xl font-bold">Grooming Services</h3>
              </div>
              {loading ? <p>Loading...</p> : (
                <ul className="space-y-3 mb-8">
              ...
              <div className="mt-auto flex justify-between items-center">
                <p className="text-xl font-semibold">From <span className="font-bold">Rs.{getMinPrice(groomingServices)}</span></p>
                <button className="bg-black text-white px-8 py-3 rounded-lg hover:bg-gray-800 transition">Book Now</button>
              </div>
            </div>
            <div>
              <img src={getSubCategoryImage(groomingServices, 'grooming')} alt="Grooming" className="rounded-lg shadow-md w-full h-[420px] object-cover" onError={(e) => e.target.src = hardcodedImages.default} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black uppercase text-gray-900">Haircuts & Styling</h2>
            <p className="mt-4 text-lg text-gray-600">Modern and classic haircuts tailored to your preferences.</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <img src={getSubCategoryImage(haircutServices, 'haircut')} alt="Haircut" className="rounded-lg shadow-md w-full h-[420px] object-cover" onError={(e) => e.target.src = hardcodedImages.default} />
            </div>
            <div className="flex flex-col">
              <div className="flex items-center gap-4 mb-4">
                <span className="bg-black text-white p-3 rounded-full"><ScissorsIcon className="h-6 w-6" /></span>
                <h3 className="text-2xl font-bold">Haircuts & Styling</h3>
              </div>
              {loading ? <p>Loading...</p> : (
                <ul className="space-y-3 mb-8">
                  {haircutServices.map(s => (
                    <li key={s.id} className="flex items-center">
                      <IconSparkles className="h-4 w-4 mr-3 text-black" /> {s.name}
                    </li>
                  ))}
              ...
              <div className="mt-auto flex justify-between items-center">
                <p className="text-xl font-semibold">From <span className="font-bold">Rs.{getMinPrice(haircutServices)}</span></p>
                <button className="bg-black text-white px-8 py-3 rounded-lg hover:bg-gray-800 transition">Book Now</button>
              </div>
            </div>
          </div>
      ...
      <section className="bg-gray-50 py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black uppercase text-gray-900">Beard Grooming</h2>
            <p className="mt-4 text-lg text-gray-600">Professional beard care for a refined appearance.</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col">
              <div className="flex items-center gap-4 mb-4">
              ...
              <div className="mt-auto flex justify-between items-center">
                <p className="text-xl font-semibold">From <span className="font-bold">Rs.{getMinPrice(beardServices)}</span></p>
                <button className="bg-black text-white px-8 py-3 rounded-lg hover:bg-gray-800 transition">Book Now</button>
              </div>
            </div>
            <div>
              <img src={getSubCategoryImage(beardServices, 'beard')} alt="Beard Grooming" className="rounded-lg shadow-md w-full h-[420px] object-cover" onError={(e) => e.target.src = hardcodedImages.default} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600">Enhance your grooming experience</p>
          </div>
      ...
      <section className="bg-black py-16 sm:py-20">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-4xl font-black uppercase text-white">Ready to Elevate Your Style?</h2>
          <p className="mt-4 text-lg text-gray-200">Book your appointment today</p>
